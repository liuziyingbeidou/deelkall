...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_c6,_c7){
...
$(_9d11).combo("setValue", "").combo("setText", ""); // 璁剧疆绌哄�
$(_9d11).combo("hidePanel"); // 鐐瑰嚮娓呯┖鎸夐挳涔嬪悗鍏抽棴鏃ユ湡閫夋嫨闈㈡澘
}},
{text:function(_9d7){
