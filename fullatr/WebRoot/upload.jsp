...
if ( contentType.indexOf("multipart/form-data") >= 0 )
{
	...
	//面料
	String srcUrl = "/opt/nginx/html/3DRES/Clothes/fabricImage/";//"D:\\Apache2.2\\htdocs\\Clothes\\fabricImage\\";//
	String minUrl = "/opt/nginx/html/3DRES/Clothes/fabricImage/min/";//"D:\\Apache2.2\\htdocs\\Clothes\\fabricImage\\min\\";//
	System.out.println(flag);
	//里料
	if(flag.equals("lin")){
		srcUrl = "/opt/nginx/html/3DRES/Clothes/liningImage/";//"D:\\Apache2.2\\htdocs\\Clothes\\liningImage\\";//
		minUrl = "/opt/nginx/html/3DRES/Clothes/liningImage/min/";//"D:\\Apache2.2\\htdocs\\Clothes\\liningImage\\min\\";//
	}
	...
	while( fileItems.hasNext() )
	{
		...
		{
			File dir = new File(minUrl);
            // 如果该目录不存在，就创建
            if (!dir.exists()) {
               dir.mkdirs();
            }
			//String virtualPath = "/opt/nginx/html/3DRES/Clothes/fabricImage/min/" + fileName + "_min" + ".jpg";
			String virtualPath = minUrl + fileName + "_min" + ".jpg";
			...
			if( isSourcePic )
			{
				...
				//result.sourceUrl = virtualPath = String.format("/opt/nginx/html/3DRES/Clothes/fabricImage/%s.%s", fileName, sourceExtendName);
